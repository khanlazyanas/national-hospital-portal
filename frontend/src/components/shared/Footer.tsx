  ...
  return (
    <footer className="w-full text-white pt-24 pb-8 px-6 md:px-16 lg:px-24 relative overflow-hidden bg-[#020813]">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        {/* Softened the gradient so the image shines through beautifully */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#020813]/90 via-[#0b2447]/80 to-[#020b1a]/95 backdrop-blur-sm"></div>
      </div>

      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-blue-600/30 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/4 pointer-events-none"></div>
      <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-teal-500/20 rounded-full blur-[120px] translate-y-1/3 -translate-x-1/4 pointer-events-none"></div>
      {/* ================================================================================== */}
      ...
      <div className="relative p-[1px] rounded-[2.5rem] bg-gradient-to-r from-blue-500/30 via-teal-400/30 to-blue-500/30 mb-20 shadow-[0_0_50px_-10px_rgba(37,99,235,0.15)] group hover:shadow-[0_0_60px_-10px_rgba(37,99,235,0.25)] transition-all duration-700 z-10">
        <div className="flex flex-col md:flex-row items-center justify-between bg-white/5 backdrop-blur-xl border border-white/10 rounded-[2.4rem] p-8 md:p-12 overflow-hidden relative">
          
          {/* Subtle inner animated glow */}
          <div className="absolute inset-0 bg-gradient-to-r from-blue-600/20 to-teal-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>

          <div className="mb-8 md:mb-0 relative z-10 w-full md:w-1/2">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 border border-white/20 text-[10px] font-bold uppercase tracking-widest text-teal-300 mb-4 shadow-sm">
          ...
          <div className="flex flex-col sm:flex-row w-full md:w-auto gap-4 relative z-10">
            <div className="relative w-full sm:w-72 lg:w-80 group/input">
              ...
              <input 
                ...
                className="w-full pl-12 pr-5 py-4.5 rounded-2xl bg-black/40 border border-white/10 focus:outline-none focus:border-blue-500/50 focus:ring-2 focus:ring-blue-500/20 text-sm text-white placeholder-gray-400 transition-all shadow-inner backdrop-blur-md"
              />
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-16 relative z-10">
        ...
        <div className="col-span-1 md:col-span-2 lg:col-span-4 lg:pr-8">
          ...
          <p className="text-sm text-blue-50/80 leading-relaxed mb-8 font-light max-w-sm">
          ...
          <div className="flex gap-4">
            {[FaFacebook, FaTwitter, FaInstagram, FaLinkedin].map((Icon, idx) => (
              <Link key={idx} href="#" className="w-10 h-10 rounded-xl bg-white/10 border border-white/20 flex items-center justify-center text-white hover:bg-blue-600 hover:border-blue-400 hover:shadow-[0_0_20px_rgba(37,99,235,0.4)] hover:-translate-y-1 backdrop-blur-md transition-all duration-300">
        ...
        <div className="lg:col-span-2">
          ...
          <ul className="space-y-4 text-sm text-blue-50/80 font-light">
            {[
              { name: "Home", path: "/" },
              ...
              <li key={idx}>
                <Link href={link.path} className="flex items-center gap-3 hover:text-white hover:translate-x-2 transition-all duration-300 group">
                  <ArrowRight className="w-3 h-3 text-blue-400 group-hover:text-blue-300 transition-colors" /> {link.name}
                </Link>
              </li>
            ))}
          </ul>
        ...
        <div className="lg:col-span-3">
          ...
          <ul className="space-y-4 text-sm text-blue-50/80 font-light">
            {[
              ...
              <li key={idx}>
                <Link href="/services" className="flex items-center justify-between hover:text-white hover:translate-x-2 transition-all duration-300 group border-b border-white/10 pb-2">
                  <span className="flex items-center gap-3"><ArrowRight className="w-3 h-3 text-teal-400 group-hover:text-teal-300 transition-colors" /> {service}</span>
                  <ArrowUpRight className="w-3 h-3 text-white/30 group-hover:text-teal-300 opacity-0 group-hover:opacity-100 transition-all" />
                </Link>
              </li>
            ))}
          </ul>
        ...
        <div className="lg:col-span-3">
          ...
          <ul className="space-y-6 text-sm text-blue-50/80 font-light">
            <li className="flex items-start gap-4 hover:text-white transition-colors cursor-pointer group">
              <div className="w-10 h-10 rounded-xl bg-white/10 border border-white/20 flex items-center justify-center shrink-0 group-hover:bg-blue-600 group-hover:border-blue-400 group-hover:shadow-[0_0_15px_rgba(37,99,235,0.4)] backdrop-blur-md transition-all duration-300">
            ...
            <li className="flex items-center gap-4 hover:text-white transition-colors cursor-pointer group">
              ...
              <span className="font-medium tracking-wide text-white text-base">+91 800 123 4567</span>
            </li>
            <li className="flex items-center gap-4 hover:text-white transition-colors cursor-pointer group">
              <div className="w-10 h-10 rounded-xl bg-white/10 border border-white/20 flex items-center justify-center shrink-0 group-hover:bg-blue-600 group-hover:border-blue-400 group-hover:shadow-[0_0_15px_rgba(37,99,235,0.4)] backdrop-blur-md transition-all duration-300">
      ...
      {/* Divider */}
      <div className="w-full h-px bg-gradient-to-r from-transparent via-white/20 to-transparent relative z-10 mb-8"></div>

      {/* Bottom Bar */}
      <div className="flex flex-col md:flex-row justify-between items-center text-xs text-blue-50/70 font-light relative z-10 pb-4">
