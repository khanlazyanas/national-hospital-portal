  ...
  return (
    <section className="relative w-full py-24 px-6 md:px-16 lg:px-24 bg-[#f8fafc] overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto text-center mb-20">
        ...
        <h2 className="text-4xl md:text-6xl font-extrabold text-[#0b2447] tracking-tight mb-6 drop-shadow-sm">
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {departments.map((dept, index) => {
          ...
          return (
            <div 
              key={index} 
              className="group relative bg-white rounded-3xl p-8 border border-gray-100 shadow-[0_10px_40px_-15px_rgba(0,0,0,0.05)] hover:shadow-[0_20px_40px_-15px_rgba(37,99,235,0.15)] transition-all duration-500 hover:-translate-y-2 cursor-pointer overflow-hidden"
            >
              ...
              <div className="relative z-10">
                ...
                {/* Content */}
                <h3 className="text-2xl font-bold text-[#0b2447] mb-4 group-hover:text-blue-600 transition-colors duration-300">
                  {dept.name}
                </h3>
                ...
                {/* Hidden Animated Action Link */}
                <div className="flex items-center gap-2 text-sm font-bold text-blue-600 opacity-0 -translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 ease-out">
