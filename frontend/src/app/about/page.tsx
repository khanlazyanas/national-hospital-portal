...
import { ShieldCheck, HeartPulse, Award, Users, Building2, CheckCircle2 } from "lucide-react";
  ...
  return (
    <main className="min-h-screen bg-[#f8fafc]">
      ...
      <section className="relative w-full pt-40 pb-32 md:pt-48 md:pb-40 px-6 md:px-16 lg:px-24 overflow-hidden bg-[#020813]">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center flex flex-col items-center">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tight mb-6 text-white drop-shadow-lg leading-tight">
            Dedicated to Your Health & <br className="hidden md:block" />
      ...
      <div className="relative z-20 -mt-12 md:-mt-20">
        ...
        <section className="bg-white rounded-t-[2.5rem] md:rounded-t-[4rem] px-6 md:px-16 lg:px-24 py-20 md:py-28 shadow-[0_-20px_40px_rgba(0,0,0,0.1)]">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-2 lg:order-1">
              <h2 className="text-3xl md:text-5xl font-extrabold text-[#0b2447] mb-6 leading-tight tracking-tight">
                ...
                <span className="text-blue-600">Healthcare Since 2001</span>
              </h2>
              <p className="text-gray-500 leading-relaxed mb-10 text-base md:text-lg font-medium">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="bg-[#f8fafc] border border-gray-100 p-6 rounded-2xl hover:shadow-[0_10px_30px_-10px_rgba(37,99,235,0.15)] transition-all duration-300">
        ...
        {/* Core Values Section */}
        <section className="w-full py-24 px-6 md:px-16 lg:px-24 bg-[#f8fafc]">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {/* Value 1 */}
              <div className="bg-white p-8 rounded-[2rem] border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgb(37,99,235,0.12)] hover:-translate-y-2 transition-all duration-500 group">
              ...
              {/* Value 2 */}
              <div className="bg-white p-8 rounded-[2rem] border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgb(37,99,235,0.12)] hover:-translate-y-2 transition-all duration-500 group">
                <div className="w-16 h-16 bg-teal-50 text-teal-600 rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 group-hover:bg-teal-500 group-hover:text-white transition-all duration-500 shadow-sm">
